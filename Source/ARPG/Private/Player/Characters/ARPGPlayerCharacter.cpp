...
void AARPGPlayerCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AARPGPlayerCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AARPGPlayerCharacter::DoMove(float Right, float Forward)
{
